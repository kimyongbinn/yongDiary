            ...
            <div class="row g-1">
           		<div class="col-12 mb-3">
                    <div class="form-floating">
                        <input type="text" class="form-control" id="memName" name="memName" placeholder="비밀번호를 입력하세요.">
                        <label for="subject">이름</label>
                    </div>
                </div>
                <div class="col-12 mb-3">
                    <div class="form-floating">
                        <input type="text" class="form-control" id="memNick" name="memNick" placeholder="닉네임을 입력하세요.">
                ...
                <div class="col-12 mb-3">
                    <div class="form-floating" style="display: flex;">
                        <input type="password" class="form-control" id="memPw1" name="memPw1" placeholder="비밀번호를 확인하세요." style="width: 85%; margin-right: 10px;">
                ...
                <div class="col-12 mb-3">
                    <div class="form-floating">
                        <input type="text" class="form-control" id="memPh" name="memPh" placeholder="전화번호를 입력하세요.">
