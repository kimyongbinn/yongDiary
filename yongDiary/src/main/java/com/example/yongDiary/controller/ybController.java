...
public class ybController {
	...
	public String test(Model modele) {	
		System.out.println("ybController test start...");
		
		
		return "map/mapSearch";
	}
	@RequestMapping(value = "/map/mapDetail")
	public String mapResult(Model model, String pointX, String pointY, String roadAddr) {	
