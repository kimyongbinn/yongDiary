...
<body>
	...
	<!-- Footer Start -->
    <div class="container-fluid bg-dark text-light wow fadeIn" data-wow-delay="0.1s" id="footer">
    ...
    <script src="${pageContext.request.contextPath}/assets/lib/isotope/isotope.pkgd.min.js"></script>
